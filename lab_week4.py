...
# Define Monster's Powers (New Feature)
monster_powers = {
    "Fire Magic": 2,
    "Freeze Time": 4,
    "Super Hearing": 6
...
# New Feature: Roll for Monster's Magic Power and Update Monster's Combat Strength
input("Roll for Monster's Magic Power (Press enter)")
monster_power = random.choice(list(monster_powers.keys()))
print("Monster's power is: " + monster_power)
# Increase monster's combat strength by the magic power value, but do not exceed 6
m_combat_strength = min(6, m_combat_strength + monster_powers[monster_power])
print("Monster's updated combat strength is: " + str(m_combat_strength))

# New Feature: Loot Collection
belt = []  # Initialize an empty array for the player's belt

print("You found a loot bag!")
input("Roll for your first loot item (Press Enter)")
first_item = random.choice(loot_options)
loot_index = loot_options.index(first_item)
first_item = loot_options.pop(loot_index)
belt.append(first_item)
print("Current items in your belt: " + str(belt))

input("Roll for your second loot item (Press Enter)")
second_item = random.choice(loot_options)
loot_index = loot_options.index(second_item)
second_item = loot_options.pop(loot_index)
belt.append(second_item)
print("Current items in your belt: " + str(belt))

print("Organizing your belt alphabetically...")
belt.sort()
print("Your organized belt: " + str(belt))
...
if loot_used in good_loot_options:
    ...
    print(f"The {loot_used} was beneficial! Your health increased to {health_points}.")
elif loot_used in bad_loot_options:
    health_points = max(0, health_points - 2)
    print(f"The {loot_used} was harmful! Your health decreased to {health_points}.")
else:
    print(f"The {loot_used} did not seem to help you.")
print("Item used: " + loot_used)
